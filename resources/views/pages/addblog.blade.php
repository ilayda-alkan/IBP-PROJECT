...
@section('content')
    <h2 class="bg-dark p-2 text-white">Add Blog</h2>
    <form method="POST" action="{{ route('blogs.store') }}">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="blogDescription" name="description" rows="5" placeholder="Write your blog description here" required></textarea>
        </div>
